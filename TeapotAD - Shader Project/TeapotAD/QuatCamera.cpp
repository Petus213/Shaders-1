...
{
	glm::quat rotation;
	rotation.w = cos(glm::radians(angle) / 2);
	rotation.x = sin(glm::radians(angle) / 2)*axis.x;
	rotation.y = sin(glm::radians(angle) / 2)*axis.y;
	rotation.z = sin(glm::radians(angle) / 2)*axis.z;
	return rotation;
